...
(function () {
  ...
  const cartPanel = drawer.querySelector("[data-cdp-panel]");
  ...
  const renderLines = (cart) => {
    ...
    if (!cart.items || cart.items.length === 0) {
      linesRoot.innerHTML = '<img width="80px" height="80px" class="empty-cart-img" style="width: 80px; height: 80px; display: block;" src="https://cdn.shopify.com/s/files/1/0796/7847/2226/files/289-2892204_your-cart-is-empty-empty-cart-icon-png_1.png" alt="Empty Cart"><div class="cdp-empty-msg">Your cart is empty.</div>';
      return;
    }
