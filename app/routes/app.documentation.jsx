...
const FEATURES = [
  ...
  },
  {
    ...
    steps: [
      ...
      <>Turn <strong>Enable</strong> on so the bar can appear in the cart drawer</>,
      <>Set all 3 <strong>milestone prices</strong> in ascending order, such as 499, 999, and 1499</>,
      <>Add the <strong>reward text</strong> for each milestone, like Free Shipping, Free Gift, or 10% Off</>,
      <>Optional: paste your own <strong>SVG icon code</strong> for each milestone. If you leave the icon empty, QuickCart uses the default icon automatically</>,
      <>Use the preview on the right side to test the milestone message and progress bar fill before saving</>,
      <>Click <strong>Save</strong> and then add products to cart on your storefront to confirm the rewards unlock correctly</>,
    ],
    tip: "Keep the first tier achievable (e.g., ₹500) to motivate initial upsells.",
  },
  {
    id: "quantityprogressbar",
    icon: "QTY",
    bg: "#dcfce7",
    title: "Quantity-Based Progress Bar",
    desc: "Unlock offers based on number of items added to cart.",
    nav: "Sidebar -> Collection Based ProgressBar / Quantity Mode",
    color: "#16a34a",
    steps: [
      <>Open <strong>Collection Based ProgressBar</strong> from the sidebar</>,
      <>Choose <strong>Quantity mode</strong> if your setup supports both price-based and quantity-based milestones</>,
      <>Enter milestone quantities like <strong>2 items</strong>, <strong>3 items</strong>, and <strong>5 items</strong> in increasing order</>,
      <>Write the reward text for each quantity milestone, for example Free Gift on 2 items or 15% Off on 5 items</>,
      <>If your quantity progress bar works only for selected products, make sure those products have the required <strong>tag or collection mapping</strong> configured in your store</>,
      <>Save the settings and test by increasing the quantity in cart until each milestone becomes active</>,
    ],
    tip: "Quantity-based rewards work especially well for bundles, mix-and-match offers, and buy-more-save-more campaigns.",
  },
  {
    id: "bxgy",
    icon: "🔄",
